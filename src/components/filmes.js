var film = [
  ...
  [
    ...
    [
      ...
      , "./O_Segredo_de_Brokeback_Mountain.jpg"
    ],
    [
      "Romance",
      "A Proposta",
    ...
    [
      ...
      "Woody Allen",
      "Diane Keaton",
      "Um humorista judeu e divorciado que faz análise há quinze anos, se apaixona por Annie Hall, uma cantora em início de carreira com uma cabeça um pouco complicada. Em pouco tempo eles decidem morar juntos, mas as crises conjugais começam a aparecer e afetar os sentimentos de ambos."
      , "./Noivo_Neurotico_Noiva_Nervosa.jpg"
    ],
    [
      "Romance",
      "Antes do Amanhecer",
      ...
      "Richard Linklater",
      "Ethan Hawke",
      "Uma jovem francesa e um rapaz americano têm um encontro casual num trem na Europa e se apaixonam rapidamente. Eles têm um único dia para passar juntos antes de retornarem a seus países de origem, e decidem passá-lo em Viena."
      , "./Antes_do_Amanhecer.jpg"
    ],
    [
      "Romance",
      ...
      "Dennis Dugan",
      "Jennifer Aniston",
      "Com o coração partido recentemente, o cirurgião plástico Danny Maccabee finge ser casado para desfrutar sem compromisso de alguns encontros. Suas mentiras funcionam bem, até que ele conhece Palmer, a mulher de seus sonhos, mas que resiste se envolver com ele. Ao invés de ser honesto, Danny pede a Katherine, sua assistente, para fingir que é sua futura ex-esposa. As mentiras acabam criando mais problemas, e Danny se vê envolvido em divertidas confusões."
      , "./Esposa_de_Mentirinha.jpg"
    ]
  ],
  [
    [
    ...
    [
      ...
      "Ridley Scott",
      "Matt Damon",
      "Durante uma missão a Marte, o astronauta americano Mark Watney é dado como morto e deixado para trás. Mas Watney ainda está vivo. Contra todas as probabilidades, ele procura uma maneira de entrar em contato com a Terra."
      , "./Perdido_em_Marte.jpg"
    ],
    [
      "Ficção Cientifica",
      "Blade Runner",
